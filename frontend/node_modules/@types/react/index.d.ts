...
declare namespace React {
    ...
    interface AriaAttributes {
        ...
        /**
         * Indicates whether inputting text could trigger display of one or more audits of the user's intended value for an input and specifies how audits would be
