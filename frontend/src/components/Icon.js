...
const PATHS = {
  ...
  discord: (<g><path d="M18.6 5.3A16.4 16.4 0 0 0 14.5 4l-.5 1a15 15 0 0 0-4 0L9.5 4a16.4 16.4 0 0 0-4.1 1.3C2.9 9.1 2.2 12.8 2.5 16.4A16.6 16.6 0 0 0 7.6 19l1.1-1.8h-1a8.6 8.6 0 0 1-1.4-.7l.3-.3a12 12 0 0 0 10.8 0l.3.3c-.4.3-.9.5-1.4.7h-1L16.4 19a16.6 16.6 0 0 0 5.1-2.6c.4-4.2-.7-7.8-2.9-11.1Z" /><path d="M9.7 13.5c-.7 0-1.3-.7-1.3-1.5s.6-1.5 1.3-1.5 1.3.7 1.3 1.5-.6 1.5-1.3 1.5Zm4.6 0c-.7 0-1.3-.7-1.3-1.5s.6-1.5 1.3-1.5 1.3.7 1.3 1.5-.6 1.5-1.3 1.5Z" /></g>),
